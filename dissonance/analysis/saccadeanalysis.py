...
from ..epochtypes import EpochBlock, groupby, SaccadeEpochs, SaccadeEpoch
...
class SaccadeAnalysis(IAnalysis):
    ...
    @property
    def name(self): return "SaccadeAnalysis"
    ...
    @property
    def tracestype(self): return SaccadeEpoch

    @property
    def tracetype(self): return SaccadeEpochs
